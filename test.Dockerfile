...
RUN git clone --recursive --depth=1 https://github.com/khs1994-php/REPO.git /root/khs1994-php/REPO \
    && cd /root/khs1994-php/REPO \
    && composer install -q \
    && composer update -q \
    && vendor/bin/phpunit
...
COPY --from=0 /root/khs1994-php/REPO /root/khs1994-php/REPO

RUN cd /root/khs1994-php/REPO \
